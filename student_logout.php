...
"image/Setting_icon.png"
					...
					<a href="Student_logout.php"><div class="nav-option option7">
						<img src=
"image/Logout_icon.png"
		...
		<div class="main">
			...
			<div class="container2">
				...
				<br>
				<div>
					<a href="student_profile.php"><button type="cancel" class="cancel">Cancel</button></a>
				</div>
